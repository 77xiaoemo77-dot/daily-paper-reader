...
tags: ["query:qmlco"]
score: 9.0
evidence: 量子机器学习中表达能力与可训练性的基础理论
tldr: 利用动力学李代数分析量子机器学习中的表达能力与训练悖论，解决贫瘠高原问题。
source: arxiv
selection_source: fresh_fetch
figures_json: "[{\"url\": \"assets/figures/arxiv/2606.31536v2/fig-001.webp\", \"caption\": \"Figure 1: Variance of the cost function gradient Var[∂θ0 C] as a function of the number of qubits n. The unstructured HEA exhibits exponential decay indicative of Barren Plateaus, whereas the symmetry-preserving SPA maintains polynomial scaling.\", \"page\": 5, \"index\": 1, \"width\": 437, \"height\": 275}, {\"url\": \"assets/figures/arxiv/2606.31536v2/fig-002.webp\", \"caption\": \"Figure 2: Scaling of the Dynamical Lie Algebra dimension dim(g) with system size n. The HEA operator space explodes exponentially, while the geometric constraints of the SPA strictly bound the DLA growth to a polynomial regime.\", \"page\": 6, \"index\": 2, \"width\": 438, \"height\": 275}]"
motivation: 量子机器学习中表达能力与可训练性的基础理论。
